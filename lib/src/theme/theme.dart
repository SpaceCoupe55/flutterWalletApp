...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    ), colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.blue).copyWith(background: LightColor.background), bottomAppBarTheme: BottomAppBarTheme(color: LightColor.background)
  );
